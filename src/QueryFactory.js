...
// const BASE_URL = 'https://orders-server-6lz7.onrender.com'
...
export const useGetOrders = (year, month, day) => {
    return useQuery(['orders', year, month, day], () => axios(BASE_URL + '/orders/' + year + '/' + month + '/' + day).then(res => res.data));
}
